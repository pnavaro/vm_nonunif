...
if (bcname == 'period') then
   ...
   do ipart = 1, nbpart
      ...
      x1 = ele%pos(ipart,1) - dt * ele%vit(ipart,1)
      y1 = ele%pos(ipart,2) - dt * ele%vit(ipart,2)
      i = 0
      ...
      if (i1>nx .or. j1>ny .or. i1<0 .or. j1<0) then
         print*,'erreur pour la case de x(n)',i1,j1
         stop
      endif
   ...
   do ipart = 1, nbpart
      ...
      if ((i1.eq.i2).and.(j1.eq.j2)) then
         ...
         call quatre_frontieres(i1,j1,x1,y1,x2,y2,tm,ele)
         
         !-- 7 frontieres traversees
         
      else if ((i2.eq.i1+1.and.j2.eq.j1) .or. &
           & (i2.eq.i1-1.and.j2.eq.j1) .or. &
           & (j2.eq.j1+1.and.i2.eq.i1) .or. &
           & (j2.eq.j1-1.and.i2.eq.i1)) then
         
         call sept_frontieres(i1,j1,i2,j2,x1,y1,x2,y2,tm,ele)
         
         !-- 10 frontieres traversees
         ...
         call dix_frontieres(i1,j1,i2,j2,x1,y1,x2,y2,tm,ele)
